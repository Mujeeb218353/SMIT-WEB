      ...
      <div className="flex flex-col md:flex-row-reverse items-center justify-evenly">
        ...
        >
          <p className="text-lg text-justify md:text-start">
            Saylani Mass IT Training (SMIT) is a flagship program launched by
            the Saylani Welfare International Trust, aimed at equipping
            individuals with cutting-edge IT skills to meet the growing demands
            of the digital economy.
          </p>
          <h2 className="text-3xl text-center md:text-end mt-2 font-bold">
